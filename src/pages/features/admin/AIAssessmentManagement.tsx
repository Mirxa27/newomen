...
import type { AIConfiguration, Assessment, AssessmentAttempt } from "@/types/features/assessment/assessment-types";
                ...
                <TableBody>
                  {assessments.map((assessment) => (
                    <TableRow key={assessment.id}>
                      ...
                      <TableCell>
                        <Select
                          value={assessment.ai_config_id ?? "unassigned"}
                          onValueChange={(value) => handleAssessmentConfigChange(assessment.id, value === "unassigned" ? null : value)}
                        >
