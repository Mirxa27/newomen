...
export const SuggestionPrompts = ({ onSelectPrompt, isConnected }: SuggestionPromptsProps) => {
  ...
  return (
    <div className="p-4 sm:p-6 glass rounded-3xl border border-white/10 shadow-lg backdrop-blur-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {suggestions.map((suggestion, index) => (
          <Button
            key={index}
            variant="ghost"
            className="h-auto py-3 px-4 flex items-start gap-3 bg-white/5 hover:bg-white/10"
