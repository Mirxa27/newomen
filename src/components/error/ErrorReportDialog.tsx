...
export function ErrorReportDialog({ error, onClose, onSubmit }: ErrorReportDialogProps) {
        ...
        <div className="mt-3">
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-2">
              Help us improve by reporting this error. Your feedback is valuable and will help us fix the issue.
            </p>
...
export function ErrorReportSuccessDialog({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border w-80 shadow-lg rounded-md bg-white">
        <div className="mt-3 text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Thank you for reporting this error. We'll investigate and fix the issue as soon as possible.
          </p>
          <button
            onClick={onClose}
...
export function ErrorReportErrorDialog({ onClose, onRetry }: { onClose: () => void; onRetry: () => void }) {
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-20 mx-auto p-5 border w-80 shadow-lg rounded-md bg-white">
        <div className="mt-3 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Failed to Submit Report</h3>
          <p className="text-sm text-gray-600 mb-4">
            We couldn't submit your error report. Please try again or contact support directly.
          </p>
