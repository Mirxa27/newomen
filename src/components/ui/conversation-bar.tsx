...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("flex w-full items-end justify-center p-3 sm:p-4", className)}
      >
        <div className="m-0 w-full gap-0 p-0 glass rounded-2xl sm:rounded-3xl border border-white/10 backdrop-blur-xl">
          <div className="flex flex-col-reverse">
            <div>
              {keyboardOpen && <Separator className="border-white/10" />}
              <div className="flex items-center justify-between gap-2 p-3 sm:p-4">
                <div className="h-8 w-[120px] md:h-10">
                  <div
                    className={cn(
                      "flex h-full items-center gap-2 rounded-md py-1",
                      "bg-white/5 text-white/70 glass backdrop-blur-sm"
                    )}
                  >
                ...
                <div className="flex items-center">
                  ...
                  <Separator orientation="vertical" className="mx-1 -my-2.5 border-white/20" />
                  <Button
                    variant="ghost"
                    size="icon"
            ...
            >
              <div className="relative px-3 pt-2 pb-3 sm:px-4 sm:pb-4">
                <Textarea
                  value={textInput}
                  onChange={handleTextChange}
                  onKeyDown={handleKeyDown}
                  placeholder="Enter your message..."
                  className="min-h-[100px] resize-none border-0 pr-12 shadow-none focus-visible:ring-0 bg-white/5 text-white placeholder:text-white/50 glass backdrop-blur-sm"
                  disabled={!isConnected}
                />
                <Button
                  size="icon"
                  ...
                  className="absolute right-6 bottom-6 h-8 w-8 text-white hover:bg-white/10"
                >
